//
// Migrated from MINIX/drivers/dpeth/dp.h
//
...
// shin: enable only NE2000
#define ENABLE_3C501    0       /* enable 3Com Etherlink I board         */
#define ENABLE_3C503    0       /* enable 3Com Etherlink II board        */
#define ENABLE_3C509    0       /* enable 3Com Etherlink III board       */
...
#endif
#define lock()                  // use spinlock?
#define unlock()                // use spinlock?
#define milli_delay(t)          { int i = 0; while (i++ < t*1000); } // busy loop... umm
